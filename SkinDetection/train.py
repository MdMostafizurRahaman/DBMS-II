...
for index in range(total_images):
    mask_image = cv2.imread(
        "/home/asif/DBMS-II/SkinDetection/ibtd/Mask/"+str(indices[index])+".bmp")
    actual_image = cv2.imread(
        "/home/asif/DBMS-II/SkinDetection/ibtd/"+str(indices[index])+".jpg")
...
fp = open('/home/asif/DBMS-II/SkinDetection/output.txt', 'w')
for r in range(256):
    for g in range(256):
        for b in range(256):
